...
**additional_errors** | [**list[Error400PIISAdditionalErrors]**](Error400PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
