...
**additional_errors** | [**list[Error400PISAdditionalErrors]**](Error400PISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
