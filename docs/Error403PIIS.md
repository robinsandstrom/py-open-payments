...
**additional_errors** | [**list[Error403PIISAdditionalErrors]**](Error403PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
