...
**additional_errors** | [**list[Error405PIISAdditionalErrors]**](Error405PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
