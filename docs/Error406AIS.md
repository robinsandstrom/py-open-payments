...
**additional_errors** | [**list[Error406AISAdditionalErrors]**](Error406AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  | [optional] 
